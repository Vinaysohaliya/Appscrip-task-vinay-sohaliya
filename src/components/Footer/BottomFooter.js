'use client'
import { Instagram, Linkedin, ChevronDown, ChevronUp, Image } from 'lucide-react';
        ...
        <footer>
            <div className={styles.bottomFooter}>
                <div className={styles.column}>
                    <div className={`${styles.dropdown} ${isCompanyInfoOpen ? styles.open : ''}`}>
                        <button className={styles.dropdownButton} onClick={toggleCompanyInfo}>
                            Company Info
                            {isCompanyInfoOpen ? <ChevronUp /> : <ChevronDown />}
                        </button>
                        <ul className={`${styles.dropdownList} ${isCompanyInfoOpen ? styles.show : ''}`}>
                ...
                <div className={styles.column}>
                    <div className={`${styles.dropdown} ${isQuickLinksOpen ? styles.open : ''}`}>
                        <button className={styles.dropdownButton} onClick={toggleQuickLinks}>
                            Quick Links
                            {isQuickLinksOpen ? <ChevronUp /> : <ChevronDown />}
                        </button>
                        <ul className={`${styles.dropdownList} ${isQuickLinksOpen ? styles.show : ''}`}>
                ...
                <div className={styles.column}>
                    <div className={`${styles.dropdown} ${isFollowUsOpen ? styles.open : ''}`}>
                        <button className={styles.dropdownButton} onClick={toggleFollowUs}>
                            Follow Us
                            {isFollowUsOpen ? <ChevronUp /> : <ChevronDown />}
                        </button>
                        <ul className={`${styles.dropdownList} ${isFollowUsOpen ? styles.show : ''}`}>
